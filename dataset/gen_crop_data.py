...
def main():
    ...
    parser.add_argument("--data_root", type=str, default='/public/home/zhouweiyu/Data/Tel')
    ...
    cropped_training_data_path = os.path.join(args.data_root, 'Tel_training_crop_aug{}_stride{}'.format(str(args.patch_size), str(args.stride)))
    ...
    for scene in all_scenes:
        ...
        for data in croped_data:
            ...
            if args.aug:
                ...
                flip_sample_2 = flip_sample(rotate_sample_2, 1)
                save_sample(flip_sample_2, cropped_training_data_path, str(counter).zfill(6))
                counter += 1
